    ...
    def forward(
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                sample, res_samples, cross_attention_scores_down = downsample_block(
                ...
                attn_down.append(cross_attention_scores_down)
            else:
        ...
        # 4. mid
        attn_mid = []
        cross_attention_kwargs = {"forward_iteration":forward_iteration,
                                  "object_positions":object_positions,
                                  "bboxes": bboxes,}
        if self.mid_block is not None:
            sample,cross_attention_scores_mid = self.mid_block(
                sample,
                emb,
                encoder_hidden_states=encoder_hidden_states,
                attention_mask=attention_mask,
            ...
            attn_mid.append(cross_attention_scores_mid)
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                sample,cross_attention_scores_up = upsample_block(
                    hidden_states=sample,
                    temb=emb,
                ...
                attn_up.append(cross_attention_scores_up)
            else:
